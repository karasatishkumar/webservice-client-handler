 ...
 * generated in the com.techiekernel.ws.jaxws.mtom package. 
...
public class ObjectFactory {
    ...
    private final static QName _DownloadImageResponse_QNAME = new QName("http://mtom.jaxws.ws.techiekernel.com/", "downloadImageResponse");
    private final static QName _DownloadImage_QNAME = new QName("http://mtom.jaxws.ws.techiekernel.com/", "downloadImage");
    private final static QName _UploadImageResponse_QNAME = new QName("http://mtom.jaxws.ws.techiekernel.com/", "uploadImageResponse");
    private final static QName _UploadImage_QNAME = new QName("http://mtom.jaxws.ws.techiekernel.com/", "uploadImage");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.techiekernel.ws.jaxws.mtom
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mtom.jaxws.ws.techiekernel.com/", name = "downloadImageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mtom.jaxws.ws.techiekernel.com/", name = "downloadImage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mtom.jaxws.ws.techiekernel.com/", name = "uploadImageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mtom.jaxws.ws.techiekernel.com/", name = "uploadImage")
